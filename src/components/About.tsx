...
const features = [{
  ...
  description: "Expertise in designing efficient database schemas for optimal performance and scalability.",
  skills: [{
    name: "MongoDB",
    color: "bg-green-600"
  }, {
  ...
  description: "Building RESTful and GraphQL APIs that are secure, well-documented, and developer-friendly.",
  skills: [{
    name: "Node.js",
    color: "bg-green-500"
  }, {
  ...
  description: "Designing scalable backend systems that can handle high loads while maintaining reliability.",
  skills: [{
    name: "JavaScript",
    color: "bg-yellow-500"
  }, {
...
const About = () => {
  return <section id="about" className="bg-secondary/30 py-16 md:py-24">
